...
public class RedisUtil {
    ...
    public Long increment(String key, long delta) {
        if (delta < 0) {
            throw new RuntimeException("delta 无效");
        }
     ...
     * @return 查询到的记录
     **/
    public Set<Object> zRangeByScore(String key, long minScore, long maxScore, long start, long end) {
        return redisTemplate.opsForZSet().rangeByScore(key, minScore, maxScore, start, end);
    }
